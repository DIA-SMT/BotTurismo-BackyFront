...
export const touristPageCopy: Record<TouristLanguage, TouristPageCopy> = {
  es: {
    ...
    phoneField: 'Teléfono',
    originField: '¿De dónde nos visitás?',
    originPlaceholder: 'Ej: Yerba Buena…',
    ...
    fieldErrors: {
      ...
      origin_required: 'Contanos de dónde nos visitás: escribí tu ciudad y elegila de la lista.',
      origin_invalid: 'Elegí tu ciudad de la lista de sugerencias.',
    },
    apiErrors: {
  ...
  en: {
    ...
    emailField: 'Email',
    phoneField: 'Phone',
    originField: 'Where are you visiting from?',
    originPlaceholder: 'E.g. Santiago…',
    ...
    fieldErrors: {
      ...
      origin_required: 'Tell us where you’re visiting from: type your city and pick it from the list.',
      origin_invalid: 'Pick your city from the suggestion list.',
    },
    apiErrors: {
