...
export const touristPageCopy: Record<TouristLanguage, TouristPageCopy> = {
  es: {
    ...
    phoneField: 'Teléfono',
    originField: '¿De dónde nos visitás? (opcional)',
    originPlaceholder: 'Elegí una opción',
    ...
    fieldErrors: {
      ...
      origin_invalid: 'Elegí la procedencia entre las opciones de la lista.',
    },
    apiErrors: {
  ...
  en: {
    ...
    emailField: 'Email',
    phoneField: 'Phone',
    originField: 'Where are you visiting from? (optional)',
    originPlaceholder: 'Choose an option',
    ...
    fieldErrors: {
      ...
      origin_invalid: 'Choose your place of origin from the list.',
    },
    apiErrors: {
