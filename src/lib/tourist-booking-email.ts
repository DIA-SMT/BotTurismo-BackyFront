...
const bookingEmailCopy: Record<TouristLanguage, BookingEmailCopy> = {
  es: {
    ...
    cancelInfo:
      'Si no podés asistir, avisanos escribiendo a turismo@smt.gob.ar o acercándote a la Oficina de Informes Turísticos así liberamos tu lugar.',
  ...
  en: {
    ...
    cancelInfo:
      'If you can’t make it, let us know at turismo@smt.gob.ar or at the Tourist Information Office so we can free up your seat.',
